...
personajes[5] = "Angela Merkel";
personajes[6] = "Katalin Kariko";
personajes[7] = "Kamala Harris";
personajes[8] = "Christine Lagarde";
personajes[9] = "Sarah Gilbert";
...
function cambiarColorPersonaje(){
    personajedia.style.backgroundColor = "#ff35c2";
...
setInterval(cambiarPersonaje, 1500);
